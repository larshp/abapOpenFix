class ZCL_AOF_STATIC definition
  public
  create public .
...
CLASS ZCL_AOF_STATIC IMPLEMENTATION.
  ...
  METHOD if_http_extension~handle_request.
    ...
    FIND REGEX '/sap/zabapopenfix/static/(.*)'
      IN lv_path
  ...
  METHOD read_mime.
    ...
    CONCATENATE '/SAP/PUBLIC/zabapopenfix/' iv_url INTO lv_url.
